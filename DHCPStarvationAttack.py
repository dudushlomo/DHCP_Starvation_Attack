...
"""
Sources:
The code made by understanding other codes and changing them to my needs. ofcourse that i could not use only
the codes in the links below. i did a lot of research in google. not all my links are here but the important ones here.
Those are the codes that used:
Interfaces:
https://stackoverflow.com/questions/3837069/how-to-get-network-interface-card-names-in-python

DHCP discover and DHCP request and DHCP ACK:
https://stackoverflow.com/questions/64245832/accessing-fields-in-scapy-dhcp-request
DHCP Offer:
https://stackoverflow.com/questions/58372129/scapy-dhcp-retrieving-offered-ip-address
https://github.com/jarekj9/scapy_dhcp_tester/blob/master/dhcpTester.py lines 181 to 210
"""
...
def main():
    ...
    # While loop that runs as long there is leases available
    while True:
...
# Python create this line for me. I choose to accept it this time.
# I want to upload the file to GitHub. So I want to make it right.
